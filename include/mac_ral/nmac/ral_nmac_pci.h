...
typedef union _INT_SOURCE_CSR_STRUC {
	struct {
		...
		unsigned int AutoWakeup:1;
		unsigned int TXFifoStatusInt:1;
		unsigned int PreTBTT:1;
		unsigned int tbttInt:1;
		unsigned int MCUCommandINT:1;
		unsigned int trCoherent:1;
		unsigned int txCoherent:1;
		unsigned int rxCoherent:1;
		unsigned int rsv3:2;
		unsigned int TxDone9:1;
		unsigned int TxDone8:1;
		unsigned int TxDone7:1;
		unsigned int TxDone6:1;
