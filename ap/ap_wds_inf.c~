...
NET_DEV_STATS *RT28xx_get_wds_ether_stats(IN PNET_DEV net_dev);
...
INT WdsVirtualIFSendPackets(IN PNDIS_PACKET pPktSrc, IN PNET_DEV pDev)
{
...
/*	if(!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_INTERRUPT_IN_USE)) */
	if (RTMP_DRIVER_IOCTL_SANITY_CHECK(pAd, NULL) != NDIS_STATUS_SUCCESS) {
		DBGPRINT(RT_DEBUG_TRACE,
			 ("VirtualIF_ioctl(%s)::Network is down!\n",
