...
static struct proc_dir_entry *entry_wl_video_Update, *entry_wl_video_Enable,
    ...
    *entry_wl_video_VideoMCS, *entry_wl_video_TxBASize,
...
ssize_t video_ClassifierEnable_set(struct file * file,
...
int wl_video_proc_init(void)
{
	...
	if (proc_ralink_wl_video) {
		entry_wl_video_Update =
		    create_proc_entry("UpdateFromGlobal", 0,
				      proc_ralink_wl_video);
		...
		entry_wl_video_ClassifierEnable =
		    create_proc_entry("ClassifierEnable", 0,
				      proc_ralink_wl_video);
		...
		entry_wl_video_HighTxMode =
		    create_proc_entry("HighTxMode", 0, proc_ralink_wl_video);
		...
		entry_wl_video_VideoMCSEnable =
		    create_proc_entry("VideoMCSEnable", 0,
				      proc_ralink_wl_video);
		...
		entry_wl_video_TxLifeTimeMode =
		    create_proc_entry("TxLifeTimeMode", 0,
				      proc_ralink_wl_video);
		...
		entry_wl_video_TxLifeTime =
		    create_proc_entry("TxLifeTime", 0, proc_ralink_wl_video);
		...
		entry_wl_video_TxRetryLimit =
		    create_proc_entry("TxRetryLimit", 0, proc_ralink_wl_video);
