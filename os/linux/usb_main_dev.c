...
#ifdef CONFIG_MULTI_CHANNEL
	pDrvNetOps->RtmpNetUsbBulkOutHCCANullFrameComplete =
	    (RTMP_DRV_USB_COMPLETE_HANDLER) RTUSBBulkOutHCCANullFrameComplete;
#endif				/* CONFIG_MULTI_CHANNEL */
...
#ifdef CONFIG_MULTI_CHANNEL
	RtmpDrvUsbBulkOutHCCANullFrameComplete =
	    pDrvNetOps->RtmpDrvUsbBulkOutHCCANullFrameComplete;
#endif				/* CONFIG_MULTI_CHANNEL */
